...
gym.register(
    id="Tesollo-Delto-DG5F-Distill-Direct-v0",
    entry_point=f"{__name__}.tesollo_delto_rl_env:TesolloDeltoRlEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.tesollo_delto_rl_env_cfg:TesolloDeltoRlDistillEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:TesolloDeltoDistillRunnerCfg",
    },
)

gym.register(
    id="Tesollo-Delto-DG5F-Yolo-Direct-v0",
    entry_point=f"{__name__}.tesollo_delto_yolo_env:TesolloDeltoYoloEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.tesollo_delto_yolo_env:TesolloDeltoYoloEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:TesolloDeltoPPORunnerCfg",
    },
)
